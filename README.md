...
Several of my biggest project repos are private due to the fact I am pulishing the artifacts of the code and are commerical in nature.  For those repos, a public repo with public information may also exist.  And, I will entertain access to the private repos via a signed NDA agreement on an as needed basis. In particular:  
